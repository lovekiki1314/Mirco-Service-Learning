...
public class Meeting implements Serializable {
    ...
    public Meeting(Long id,String chairName, String meetingName, String acronym, String region, String city, String venue, Set<String> topic, String organizer, String webPage, String submissionDeadlineDate, String notificationOfAcceptanceDate, String conferenceDate, String approval) {
        this.id=id;
