...
public class ArticleController {
    ...
    @GetMapping("/meeting/getArticleByContributorNameAndMeetingName")
    public List<Article> getArticleByContributorNameAndMeetingName(String contributeName,String meetingName){
        logger.debug("getArticleByContributorNameAndMeetingName: " + contributeName+" "+meetingName);

        return service.getArticleByContributorNameAndMeetingName(contributeName, meetingName);
    }
    ...
    public void saveReviewRelation(@RequestBody ReviewRelation reviewRelation){
