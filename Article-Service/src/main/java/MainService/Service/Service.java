...
public class Service {
    ...
    public List<Article> getArticleByContributorNameAndMeetingName(String contributeName,String meetingName) {
        List<Article> ret = articleService.getArticleByContributorNameAndMeetingName(contributeName, meetingName);
        if(ret != null){
            logger.info("Get Articles by contributeName and meetingName: " + contributeName + ", " + meetingName);
        }
        return ret;
    }
