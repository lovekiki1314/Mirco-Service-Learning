  ...
  export default {
    ...
    methods: {
      ...
      loadRelatedMeetings(){
        ...
        let requestUrl = {
          chairMeeting:"api/meeting/chairMeeting",
          pcMemberMeeting: "api/meeting/pcMemberMeeting",
          authorMeeting:"api/meeting/authorMeeting",
          availableMeeting:"api/meeting/availableMeeting"
        };
        let that = this;
