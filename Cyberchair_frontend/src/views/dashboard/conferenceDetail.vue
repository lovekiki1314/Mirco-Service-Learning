...
export default {
    ...
    methods: {
        ...
        review(strategy){
            ...
            let requestUrl2 = 'api/Notification/beginReviewNotification'
            let meetingName = this.$route.query.meetingName

            this.$axios.post(requestUrl2,
            {
                meetingName: meetingName,
        ...
        publishFinalResult(){
            ...
            let requestUrl2 = 'api/Notification/finalPublishNotification'
            let meetingName = this.$route.query.meetingName
            this.$axios.post(
            requestUrl, {
                meetingName: meetingName
